...
(function testIsValidObjectID() {
    assert.equal(convert.isValidObjectID(objectID), true);
    assert.equal(convert.isValidObjectID('1234123213'), false);
})();
...
(function testCreateGraphQL() {
    ...
    const result = '\n'.concat(
        ...
        assert.equal(convert.createGraphQL(jobs), convert.createGraphQL(nestedJob));
